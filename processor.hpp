...
private:
	...
	uint64_t randomPage;
	void resetCounters();
	void writeAddress64(const uint64_t& address);
	void writeAddress32(const uint64_t& address);
	void writeAddress16(const uint64_t& address);
	void writeAddress8(const uint64_t& address);
